...
This 1.1.3 installer is only locally ad-hoc signed, without a Developer ID signature or Apple notarization, so it is not a formally notarized package free of security warnings.
