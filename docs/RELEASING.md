...
```sh
xcrun notarytool submit release/Snake-1.1.0-macos-arm64.dmg --keychain-profile <你的公证配置名> --wait
...
- `swift test --disable-sandbox --filter 'WorkspaceDraggingTests|SFTPShortcutTests'`：24 项通过。
